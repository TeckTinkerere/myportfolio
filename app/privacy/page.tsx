...
export default function PrivacyPage() {
  return (
    <Section className="max-w-3xl">
      <h1 className="text-headline font-semibold text-ink">Privacy</h1>
      ...
      <div className="prose-measure mt-10 flex flex-col gap-8">
        <section>
          <h2 className="text-title font-semibold text-ink">What this site collects</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-title font-semibold text-ink">If you use the contact form</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-title font-semibold text-ink">How long I keep it</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-title font-semibold text-ink">Testimonials and quoting</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-title font-semibold text-ink">Spam protection</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-title font-semibold text-ink">Getting in touch about this</h2>
          <p className="mt-3">
