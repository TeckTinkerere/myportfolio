...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  //   /p/<code> — every short link redirects to a /work/<slug> already
  //     listed below, so advertising both offers a search engine two URLs
  //     for one page.
  //   /emcee   — run sheets moved to their own deployment and have their own
  //     sitemap there. This site only redirects to them.
  return [
