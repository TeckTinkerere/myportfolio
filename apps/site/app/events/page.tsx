      ...
      */}
      <Section className="pt-0">
        <div className="rounded-sm border border-dashed border-border p-6">
          <h2 className="text-sm font-semibold text-ink">How I run a room</h2>
          <p className="prose-measure mt-2 text-sm leading-relaxed text-ink-muted">
            The run sheets I host from — running order, host notes, transitions and the
            announcements that get forgotten — including a reusable template for an
            evening meetup.
          </p>
