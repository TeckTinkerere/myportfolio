      ...
      <Section className="pb-0">
        ...
        <header>
          <div className="flex flex-wrap items-center gap-x-4 gap-y-3">
            ...
            {/* Share sits with the status readouts, not at the foot of the
                page — the link is most often wanted while talking about the
                work, which is before anyone has scrolled. */}
            <ProjectShare
              slug={project.slug}
              title={project.title}
              className="ml-auto"
