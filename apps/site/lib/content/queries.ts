 ...
 *
 * The predicate itself now lives in @mohdaslam/content-rules, because the
 * emcee app has to gate its run sheets by exactly the same rule. Re-exported
 * so this module remains the single place portfolio code asks the question.
 */
export { isPublished }
