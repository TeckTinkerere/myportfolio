  ...
  const projects = [
    {
      ...
      image: "/mainpage.jpg",
      tags: ["React.js", "Node.js", "Express", "SQL", "Startup", "Leadership"],
      category: "startup",
      status: "active",
      github: "https://github.com/mohamedaslam/local-loco",
      demo: "https://local-loco-demo.vercel.app",
    ...
    },
    {
      ...
      demo: "https://startup-link-demo.vercel.app",
      features: ["Student networking", "Mentor matching", "Project collaboration", "Resource sharing","Founder-led", "Ecosystem building", "Student collaboration"],
    },
    {
      id: 3,
      ...
      github: null,
      demo: null,
      features: ["AI prototyping", "Hackathon finalist", "Cloud deployment"],
    },
    {
      id: 4,
    ...
    {
      id: 6,
      title: "Video Content Creator Tool",
      description:
        "A web-based tool for content creators to manage video projects, track editing progress, and collaborate with team members. Integrates with popular editing software.",
      image: "/placeholder.svg?height=300&width=400",
      tags: ["React.js", "Express.js", "Socket.io", "AWS S3"],
      category: "frontend",
      status: "in-progress",
      github: "https://github.com/mohamedaslam/video-creator-tool",
      demo: null,
      features: ["Project management", "Real-time collaboration", "File sharing", "Progress tracking"],
    },
    {
      id: 7,
      title: "SPCyclists Community App",
      description:
        "A mobile-responsive web app for the SPCyclists community to organize rides, track routes, and share experiences. Features GPS tracking and social elements.",
      image: "/placeholder.svg?height=300&width=400",
      tags: ["React.js", "PWA", "GPS API", "Firebase"],
      category: "team-based",
      status: "completed",
      github: "https://github.com/mohamedaslam/spcyclists-app",
      demo: "https://spcyclists-demo.vercel.app",
      features: ["Route tracking", "Community features", "Event organization", "Performance analytics"],
    },
  ]
